...
declare namespace wx {
    ...
    function checkSession(option: LoginOptions): void;
    ...
    function getMenuButtonBoundingClientRect(): { width: number, height: number, top: number, right: number, buttom: number, left: number };
    /**
     * 取消监听小游戏回到前台的事件
     * @param callback 
     */
