...
declare namespace BK
{
        ...
        export class Webview{
         ...
         export class Account{
              ...
              */
                ...
                static getHeadEx(openId, callback:(openId, imgPath)=>void);
             /**
              * 获取昵称
              * 
              * @static
    ...
    export class Advertisement {
        ...
        /**
         * 
         * @param videoType 拉去广告
         * @param callBack 
         */
        static fetchVideoAd(videoType,callBack:(retCode:number,msg:string,handle:any)=>void);
        
        /**
         * 啦取banner 广告
         * @param callBack 
         */
        static fetchBannerAd(callBack:(retCode, msg, adBannerHandle)=>void);
    ...
    export class QQ
    {
        ...
        static skipGame(desGameId, extendInfo?:string);

        static isOpenActivityPage();
        static showRedPackageActivityPage();
        /**
         * 获取openKey
         * @param callback 
         */
        static fetchOpenKey(callback:Function);
         ...
         * @param callBack 
         */
        static reportGameResult(data:any,callBack:Function);
        /**
         * @param shareInfo 分享
         * @param callFunc 
         */
        static share(shareInfo:any,callFunc:Function);

        /**
         * 成绩上报与排行榜（新）
         * @param gameMode       gameMode: 游戏模式，如果没有模式区分，直接填 1
         * @param data 
         * @param callBack 
         */
        static uploadScoreWithoutRoom(gameMode, data, callBack:(errCode, cmd, data)=>void);

        /**
         * 拉取排行榜
         * @param attr                  //使用哪一种上报数据做排行，可传入score，a1，a2等
         * @param order                 //排序的方法：[ 1: 从大到小(单局)，2: 从小到大(单局)，3: 由大到小(累积)]
         * @param rankType              var rankType = 0; //要查询的排行榜类型，0: 好友排行榜，1: 群排行榜，2: 讨论组排行榜，3: C2C二人转 (手Q 7.6.0以上支持)
         * @param callBack 
         */
        static getRankListWithoutRoom(attr:string,order:number,rankType:number,callBack:(errCode:number,cmd:number,data:any)=>void);

        /**
         * 获取游戏所有可购买的道具
         * @param callBack 
         */
        static getGameItemList(callBack:(errorCode:number,cmd:any,data:any)=>void);

        /**
         * 获取用户拥有的游戏道具
         * @param callBack 
         */
        static getUserGameItems(callBack:(errorCode:number,cmd:any,data:any)=>void);

        /**
         * 购买支付
         */
        static qPayPurchase(gameOrientation:number,transparent:boolean,itemList:any[],callback:(errCode:number,data:any)=>void);
        
            // static getGameItemList(function(errCode,cmd,data){
